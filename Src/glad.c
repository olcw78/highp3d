/*
    ...
    OpenGL loader generated by glad 0.1.33 on Sun Jun 21 11:14:22 2020.
...
static int get_exts(void) {
    ...
    if(max_loaded_major < 3) {
        ...
        for(index = 0; index < (unsigned)num_exts_i; index++) {
            ...
            size_t length = strlen(gl_str_tmp);

            char *local_str = (char*)malloc((length+1) * sizeof(char));
            if(local_str != NULL) {
                memcpy(local_str, gl_str_tmp, (length+1) * sizeof(char));
            }
