...
GLM_FUNC_QUALIFIER void glm_mat4_rotate(__m128 const in[4], float Angle, float const v[3], __m128 out[4])
{
	...
	//RotateDir[0][0] = c + temp[0] * axis[0];
	//RotateDir[0][1] = 0 + temp[0] * axis[1] + s * axis[2];
	//RotateDir[0][2] = 0 + temp[0] * axis[2] - s * axis[1];
	...
	//RotateDir[1][0] = 0 + temp[1] * axis[0] - s * axis[2];
	//RotateDir[1][1] = c + temp[1] * axis[1];
	//RotateDir[1][2] = 0 + temp[1] * axis[2] + s * axis[0];
	...
	//RotateDir[2][0] = 0 + temp[2] * axis[0] + s * axis[1];
	//RotateDir[2][1] = 0 + temp[2] * axis[1] - s * axis[0];
	//RotateDir[2][2] = c + temp[2] * axis[2];
	...
	//Result[0] = m[0] * RotateDir[0][0] + m[1] * RotateDir[0][1] + m[2] * RotateDir[0][2];
	//Result[1] = m[0] * RotateDir[1][0] + m[1] * RotateDir[1][1] + m[2] * RotateDir[1][2];
	//Result[2] = m[0] * RotateDir[2][0] + m[1] * RotateDir[2][1] + m[2] * RotateDir[2][2];
	//Result[3] = m[3];
	//return Result;
